...
style:
	...
	pylint --disable=R0913,R0903,R0902,R0914,W0718,R0917,R0801,C0411 ./${FEATURESTORE_FOLDER}/

test:
	${PYTHON} -m flake8 ./${FEATURESTORE_FOLDER}/
	${PYTHON} -m mypy ./${FEATURESTORE_FOLDER}/
	${PYTHON} -m pylint --disable=R0913,R0903,R0902,R0914,W0718,R0917,R0801,C0411 ./${FEATURESTORE_FOLDER}/
